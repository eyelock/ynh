...
Optional file at persona root. Copied to vendor-specific filename at runtime:
...
Last source wins. Persona's own `instructions.md` takes priority over included repos.
