...
Full step-by-step procedure lives in `.claude/commands/release.md`, which implements this rule literally — cut, PR, true merge, tag, back-merge, forward-port, then delete.
